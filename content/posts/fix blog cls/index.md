...
![Lighthouse测试报告](lighthouse_result.png)

根据苏卡卡大佬的文章，分析页面是由于文章封面的图片缺少宽高导致出现CLS问题。

为了解决这个问题，需要指定封面的宽高参数。

![cover.html code](cover-code.png)
...
2. 自定义封面文件
    ...
    ![cos-img-process](cos-img-process.png)
...
![figure.html code](figure-code.png)
...
![gtmetrix-result](gtmetrix-result.png)
